...
func TestPostgresRegister(t *testing.T) {
...
func TestPostgresRegisterDuplicateEmail(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresRegisterDuplicateOrg(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresValidateAPIKey(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresValidateAPIKeyInvalid(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresCreateAPIKey(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresListAPIKeys(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresDeleteAPIKey(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresGetAuthInfo(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresCreateInvite(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresCreateInviteAlreadyMember(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresAcceptInvite(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresAcceptInviteExistingUser(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()

	admin, org1, _, err := s.Register(ctx, "admin@example.com", "Org1")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	...
	expires := time.Now().Add(7 * 24 * time.Hour)
	_, rawToken, err := s.CreateInvite(ctx, org1.ID, "existing@example.com", models.OrgRoleMember, admin.ID, expires)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestPostgresAcceptInviteExpired(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresAcceptInviteInvalidToken(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresListInvites(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
...
func TestPostgresRevokeInvite(t *testing.T) {
	s := newPostgresStore(t)
	ctx := context.Background()
